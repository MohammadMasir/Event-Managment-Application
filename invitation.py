...
class InviteeAttendeePage():
    ...
    def invitation_list_screen(self):
        ...
        self.invitationpage = Page(self.main, self.inv_list_frame, "DemeEven", "Invitation List")
    ...
    def event_emails(self):
        ...
        self.emailspage = Page(self.main, self.emails_list_frame, "DemeEven", "Event Emails")
    ...
    def planner_alerts(self):
        ...
        self.plannerpage = Page(self.main, self.plannerframe, "DemeEven", "Planner Alerts")
    ...
    def attendee_list_screen(self):
        ...
        self.attendeepage = Page(self.main, self.attendee_list_frame, "DemeEven", "Attendee List")
    ...
    def certificates_screen(self):
        ...
        self.certificatespage = Page(self.main, self.certificates_frame, "DemeEven", "Certificates")
