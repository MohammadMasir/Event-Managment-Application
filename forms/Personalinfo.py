...
class Personal_information():
    ...
    def Personal_info(self):
        self.main_scrollable_frame = ctk.CTkScrollableFrame(self.main_frame,width = 900,fg_color = "white smoke")
        ...
        self.upper_frame = ctk.CTkFrame(self.main_scrollable_frame, fg_color="white smoke")
        ...
        self.mandatory = ctk.CTkLabel(self.lower_frame,text = "Fill out the Information below,then click Next to continue",text_color = "#006AE1",font = ctk.CTkFont(size = 15,weight = "normal"))
        ...
        self.first_name_entry = ctk.CTkEntry(self.lower_frame,height = 35,width = 800,corner_radius = 5,fg_color="white smoke", border_color="#182261")
        ...
        self.last_name_entry = ctk.CTkEntry(self.lower_frame,height = 35,width = 800,corner_radius = 5,fg_color="white smoke", border_color="#182261")
        ...
        self.email_entry = ctk.CTkEntry(self.lower_frame,height = 35,width = 800,corner_radius = 5,fg_color="white smoke", border_color="#182261")
        ...
        self.mobile_entry = ctk.CTkEntry(self.lower_frame,height = 35,width = 800,corner_radius = 5,fg_color="white smoke", border_color="#182261")
        ...
        self.company_entry = ctk.CTkEntry(self.lower_frame,height = 35,width = 800,corner_radius = 5, fg_color="white smoke",border_color="#182261")
        ...
        self.title_entry = ctk.CTkEntry(self.lower_frame,height = 35,width = 800,corner_radius = 5, fg_color="white smoke", border_color="#182261")
        ...
        self.cancel = ctk.CTkButton(inside_button_fr,text = "Cancel",height = 30,width = 100,corner_radius = 5,border_width = 1,border_color = "#006AE1",text_color = "#006AE1",fg_color = "transparent")
        self.cancel.pack(side="left", padx=(0,10))

        self.next = ctk.CTkButton(inside_button_fr,text = "Next",height = 30,width = 100,corner_radius = 5,border_width = 1,text_color = "white",fg_color = "#006AE1", border_color="#006AE1")
        self.next.pack(side="right")

        self.theme_designer = ThemeDesigner(self.right_scrollable_frame, self, 1)
