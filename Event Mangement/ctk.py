...
labimg = customtkinter.CTkButton(screen,image = my_img,text = "",fg_color = "#F0F0F0",hover_color = "white",width = 15,border_width = 1,border_color = "black",command = onclick)
...
l1.place(x = 70,y = 53)
l2.place(x = 70,y = 81)
#scrollable_frame = customtkinter.CTkScrollableFrame(screen,height = 300,width = 700,fg_color = "white")
#scrollable_frame.place(x = 70,y = 125)
f1 = customtkinter.CTkFrame(screen,fg_color = "white",height = 900,width = 800)
f1.place(x = 70,y = 125)
...
x4 = StringVar()
opt2 =  customtkinter.CTkComboBox(f1,variable = x4,height = 35,width = 200,corner_radius = 5,border_width = 1,border_color = "gray",fg_color = "white",text_color = "black",button_hover_color = "#7D6D6D",font = ("semibold",17),values = ["USA","INDIA","CANADA"])
...
labimg3 = customtkinter.CTkButton(screen,image = img3,text = "",fg_color = "#F0F0F0",hover_color = "white",width = 15,border_width = 1,border_color = "black",command = close)
