    ...
    def create_event(self):
        ...
        def check_x1():
            ...
            if self.end_date.get() == "":
                showerror(title = "Error",message = "Please Enter end date")
            if self.start_time .get() == "":
                showerror(title = "Error",message = "Please Enter start time")
            if self.end_time .get() == "":
                showerror(title = "Error",message = "Please Enter end time")
            else:
        ...
        self.event_name=ctk.StringVar()
        e1 = ctk.CTkEntry(self.inside_scrollable_frame,corner_radius = 5,text_color = "black",fg_color = "white",height = 35,width = 690,textvariable = self.event_name)
        ...
        e2 = ctk.CTkEntry(self.inside_scrollable_frame,corner_radius = 5,text_color = "black",fg_color = "white",height = 35,width = 200,textvariable = self.first_name)
        e2.place(x = 30,y = 250)
        ...
        e3 = ctk.CTkEntry(self.inside_scrollable_frame,corner_radius = 5,text_color = "black",fg_color = "white",height = 35,width = 200,textvariable = self.last_name)
        ...
        self.planner_email =ctk.StringVar()
        e4 = ctk.CTkEntry(self.inside_scrollable_frame,corner_radius = 5,text_color = "black",fg_color = "white",height = 35,width = 200,textvariable = self.planner_email)
        ...
        label12 = ctk.CTkLabel(self.inside_scrollable_frame,text = "*Event Dates (YYYY-MM-DD.)",text_color = "black",font = ("darkbold",23))
        ...
        e12 = ctk.CTkEntry(self.inside_scrollable_frame,corner_radius = 5,text_color = "black",fg_color = "white",height = 35,width = 145,textvariable = self.start_date)
        ...
        e13 = ctk.CTkEntry(self.inside_scrollable_frame,corner_radius = 5,text_color = "black",fg_color = "white",height = 35,width = 145,textvariable = self.start_time )
        ...
        e14 = ctk.CTkEntry(self.inside_scrollable_frame,corner_radius = 5,text_color = "black",fg_color = "white",height = 35,width = 145,textvariable = self.end_date)
        ...
        e15 = ctk.CTkEntry(self.inside_scrollable_frame,corner_radius = 5,text_color = "black",fg_color = "white",height = 35,width = 145,textvariable = self.end_time )
