...
f2 = ctk.CTkFrame(root,height = 44,width = 1300,fg_color = "white")
f2.place(x = 0,y = 41)
...
x3 = StringVar()
e1 = ctk.CTkEntry(f2,height = 28,width = 250,corner_radius = 15,fg_color = "#ffffff",text_color = "black",placeholder_text = "Search this event",placeholder_text_color = "black",textvariable = x3)
e1.place(x = 1000,y = 5)
...
f3 = ctk.CTkFrame(root,fg_color = "white",height = 600,width = 250,border_width = 1,border_color = "lightgray")
f3.place(x = 0,y = 81)

#sidebar_frame = ctk.CTkFrame(f3,height = 300,width = 500,fg_color = "lightgray")
...
f0 = ctk.CTkScrollableFrame(root,height = 700,width = 1010,fg_color = "#F0F0F0")
f0.place(x = 250,y = 82)

f01 = ctk.CTkFrame(f0,height = 1050,width = 1010,fg_color = "#F0F0F0")
...
label8 = ctk.CTkLabel(f4,text = "Upcoming",fg_color = "#FEEEAB",text_color = "#EB9E29",corner_radius = 5,height = 10,width = 9,padx = 2,pady = 2,font = ctk.CTkFont(size = 19))
...
label16 = ctk.CTkLabel(f0,text = "Event Overview",text_color = "black",font = ctk.CTkFont(size = 18,weight = "bold"))
...
img17 = ctk.CTkImage(dark_image = Image.open(r"pics\pending.png"),size = (30,25))
